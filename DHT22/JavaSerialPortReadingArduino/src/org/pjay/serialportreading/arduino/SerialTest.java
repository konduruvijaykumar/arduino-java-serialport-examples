 ...
 * 
 */
package org.pjay.serialportreading.arduino;
...
public class SerialTest implements SerialPortEventListener {
	...
	*/
	...
	public static void main(String[] args) throws Exception {
		...
		// Added to terminate main thread by closing the port, else the application will get hanged or continue listening to events on port  
		t.join();
